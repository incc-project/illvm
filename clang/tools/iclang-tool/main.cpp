...
class IClangToolTask : public ForwardingTask {
private:
  IClangToolTask() : ForwardingTask("iclang-tool", "", nullptr) {}

public:
  static IClangToolTask *getInstance() {
    static IClangToolTask instance;
    return &instance;
  }
};
...
private:
  ...
  explicit HelloTask(IClangToolTask *iClangToolTask)
      : ExecutingTask("hello", "Print Hello + helloContent", iClangToolTask) {
    argNames.emplace_back("helloContent");
  }

public:
  __attribute__((constructor)) static HelloTask *getInstance() {
    static HelloTask instance(IClangToolTask::getInstance());
    return &instance;
  }
};
...
private:
  ...
  explicit IncLineStaTask(IClangToolTask *iClangToolTask)
      : ExecutingTask("incLineSta", "Inc line sta", iClangToolTask) {
    argNames.emplace_back("projectPath");
  }

public:
  __attribute__((constructor)) static IncLineStaTask *getInstance() {
    static IncLineStaTask instance(IClangToolTask::getInstance());
    return &instance;
  }
};
...
private:
  ...
  explicit LineMacroStaTask(IClangToolTask *iClangToolTask)
      : ExecutingTask("lineMacroSta", "Line macro sta", iClangToolTask) {
    argNames.emplace_back("projectPath");
  }

public:
  __attribute__((constructor)) static LineMacroStaTask *getInstance() {
    static LineMacroStaTask instance(IClangToolTask::getInstance());
    return &instance;
  }
};
...
int main(const int argc, char **argv) {
  ...
  const Task *task = IClangToolTask::getInstance();
